...
export default defineEventHandler(async (event) => {
  ...
  return {
    ...
    closedAt: t.closedAt,
    isSanctioned: t.isSanctioned,
    divisionOpen: t.divisionOpen,
    divisionWomen: t.divisionWomen,
    divisionMaster: t.divisionMaster,
    divisionGrandMaster: t.divisionGrandMaster,
    divisionSeniorGrandMaster: t.divisionSeniorGrandMaster,
    divisionLegend: t.divisionLegend,
    divisionJunior: t.divisionJunior,
    keepJuniorsSeparate: t.keepJuniorsSeparate,
    showDivisionInResults: t.showDivisionInResults,
    hasGolf: t.hasGolf,
