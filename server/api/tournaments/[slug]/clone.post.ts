...
export default defineEventHandler(async (event) => {
  ...
  const sourceRows = await db
    .select({
      ...
      isSanctioned: tournament.isSanctioned,
      divisionOpen: tournament.divisionOpen,
      divisionWomen: tournament.divisionWomen,
      divisionMaster: tournament.divisionMaster,
      divisionGrandMaster: tournament.divisionGrandMaster,
      divisionSeniorGrandMaster: tournament.divisionSeniorGrandMaster,
      divisionLegend: tournament.divisionLegend,
      divisionJunior: tournament.divisionJunior,
      keepJuniorsSeparate: tournament.keepJuniorsSeparate,
      showDivisionInResults: tournament.showDivisionInResults,
  ...
  const inserted = await db.transaction(async (tx) => {
    const created = await tx
      ...
      .values({
        ...
        paymentInformation: source.paymentInformation ?? null,
        facilities: source.facilities ?? null,
        ...
        registrationOpenDate: source.registrationOpenDate ?? null,
        registrationCloseDate: source.registrationCloseDate ?? null,
        closedAt: null,
        isSanctioned: !!source.isSanctioned,
        divisionOpen: source.divisionOpen !== false,
        divisionWomen: source.divisionWomen !== false,
        divisionMaster: !!source.divisionMaster,
        divisionGrandMaster: !!source.divisionGrandMaster,
        divisionSeniorGrandMaster: !!source.divisionSeniorGrandMaster,
        divisionLegend: !!source.divisionLegend,
        divisionJunior: !!source.divisionJunior,
        keepJuniorsSeparate: !!source.keepJuniorsSeparate,
        showDivisionInResults: !!source.showDivisionInResults,
        hasGolf: !!source.hasGolf,
        golfRounds: source.golfRounds ?? null,
        golfCumulativeRounds: source.golfCumulativeRounds ?? null,
        hasAccuracy: !!source.hasAccuracy,
        accuracyRounds: source.accuracyRounds ?? null,
        accuracyCumulativeRounds: source.accuracyCumulativeRounds ?? null,
        hasDistance: !!source.hasDistance,
        distanceRounds: source.distanceRounds ?? null,
        distanceCumulativeRounds: source.distanceCumulativeRounds ?? null,
        hasSCF: !!source.hasSCF,
        scfRounds: source.scfRounds ?? null,
        scfCumulativeRounds: source.scfCumulativeRounds ?? null,
        hasDiscathon: !!source.hasDiscathon,
        discathonRounds: source.discathonRounds ?? null,
        discathonCumulativeRounds: source.discathonCumulativeRounds ?? null,
        hasDDC: !!source.hasDDC,
        ddcRounds: source.ddcRounds ?? null,
        ddcCumulativeRounds: source.ddcCumulativeRounds ?? null,
        hasFreestyle: !!source.hasFreestyle,
        freestyleRounds: source.freestyleRounds ?? null,
        freestyleCumulativeRounds: source.freestyleCumulativeRounds ?? null,
        changedBy,
        createdAt: now,
        changedAt: now,
      })
