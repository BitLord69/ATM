<template>
  <div class="flex flex-col gap-6 max-w-sm mx-auto mt-20">
    <!-- Email -->
    ...
    <button class="btn bg-[#1A77F2] text-white border-[#005fd8]">
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 32 32"
      ><path fill="white" d="M8 12h5V8c0-6 4-7 11-6v5c-4 0-5 0-5 3v2h5l-1 6h-4v12h-6V18H8z" /></svg>
      Login with Facebook
    </button>
    ...
    <button class="btn bg-black text-white border-black">
      <svg
        ...
        viewBox="0 0 300 271"
        xmlns="http://www.w3.org/2000/svg"
      ><path fill="currentColor" d="m236 0h46l-101 115 118 156h-92.6l-72.5-94.8-83 94.8h-46l107-123-113-148h94.9l65.5 86.6zm-16.1 244h25.5l-165-218h-27.4z" /></svg>
      Login with X
    </button>
    ...
    <button class="btn bg-[#2F2F2F] text-white border-black">
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      ><path d="M96 96H247V247H96" fill="#f24f23" /><path d="M265 96V247H416V96" fill="#7eba03" /><path d="M96 265H247V416H96" fill="#3ca4ef" /><path d="M265 265H416V416H265" fill="#f9ba00" /></svg>
